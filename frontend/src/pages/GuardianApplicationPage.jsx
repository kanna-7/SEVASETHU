...
export default function GuardianApplicationPage() {
  ...
  const submit = async (event) => {
    ...
    setLoading(true);
    try { await registerHome({ ...form, googleVerificationToken: verificationToken }); setSubmitted(true); }
